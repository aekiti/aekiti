                                                    ...
                                                    <div class="card-header bg-transparent pb-5">
                                                        ...
                                                        <div class="btn-wrapper text-center">
                                                            <a href="#" class="btn btn-neutral btn-icon">
                                                                <span class="btn-inner--icon"><img src="{{ asset('dashboard') }}/img/icons/common/github.svg"></span>
                                                                <span class="btn-inner--text">Github</span>
                                                            </a>
                                                            <a href="#" class="btn btn-neutral btn-icon">
                                                                <span class="btn-inner--icon"><img src="{{ asset('dashboard') }}/img/icons/common/google.svg"></span>
...
@push('css')
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/animate.css/animate.min.css">
...
@push('js')
    ...
    <script src="{{ asset('dashboard') }}/assets/bootstrap-notify/bootstrap-notify.min.js"></script>
@endpush
