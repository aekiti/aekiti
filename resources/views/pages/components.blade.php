...
@push('css')
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/select2/dist/css/select2.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/quill/dist/quill.core.css">
@endpush

@push('js')
    <script src="{{ asset('dashboard') }}/assets/select2/dist/js/select2.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/nouislider/distribute/nouislider.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/quill/dist/quill.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/dropzone/dist/min/dropzone.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
@endpush
