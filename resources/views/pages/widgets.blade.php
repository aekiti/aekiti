    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="card">
                    <!-- Card image -->
                    <img class="card-img-top" src="{{ asset('dashboard') }}/img/theme/img-1-1000x900.jpg" alt="Image placeholder">
                    <!-- Card body -->
                    <div class="card-body">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/team-2.jpg">
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/team-3.jpg">
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/team-4.jpg">
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/team-5.jpg">
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                        ...
                        <div class="list-group list-group-flush">
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    <div>
                                        <div class="d-flex w-100 align-items-center">
                                            <img src="{{ asset('dashboard') }}/img/theme/team-1.jpg" alt="Image placeholder" class="avatar avatar-xs mr-2" />
                            ...
                            <a href="#" class="list-group-item list-group-item-action flex-column align-items-start py-4 px-4">
                                <div class="d-flex w-100 justify-content-between">
                                    <div>
                                        <div class="d-flex w-100 align-items-center">
                                            <img src="{{ asset('dashboard') }}/img/theme/team-2.jpg" alt="Image placeholder" class="avatar avatar-xs mr-2" />
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('dashboard') }}/img/icons/cards/mastercard.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-lg-4">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/bootstrap.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/angular.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/sketch.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/react.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('dashboard') }}/img/theme/vue.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('dashboard') }}/img/icons/cards/paypal.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-lg-4">
                        ...
                        <ul class="list-group list-group-flush list my--3">
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Country flag -->
                                        <img src="{{ asset('dashboard') }}/img/icons/flags/US.png" alt="Country flag" />
                                    </div>
                                    <div class="col">
                                        <small>Country:</small>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Country flag -->
                                        <img src="{{ asset('dashboard') }}/img/icons/flags/DE.png" alt="Country flag" />
                                    </div>
                                    <div class="col">
                                        <small>Country:</small>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Country flag -->
                                        <img src="{{ asset('dashboard') }}/img/icons/flags/GB.png" alt="Country flag" />
                                    </div>
                                    <div class="col">
                                        <small>Country:</small>
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('dashboard') }}/img/icons/cards/visa.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
                                <span class="badge badge-lg badge-success">Active</span>
                            </div>
...
@push('css')
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/fullcalendar/dist/fullcalendar.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/sweetalert2/dist/sweetalert2.min.css">
@endpush

@push('js')
    <script src="{{ asset('dashboard') }}/assets/moment/min/moment.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/fullcalendar/dist/fullcalendar.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/sweetalert2/dist/sweetalert2.min.js"></script>
