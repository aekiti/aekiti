...
@section('pageTitle','ækiti - Terms & Conditions')
@section('pageDescription', 'These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and ækiti æmbassy')
    ...
    <div class="container">
      <div class="justify-content-center">
        <div>
          ...
          <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and ækiti æmbassy, located at TechHub EKSU, Ado-Ekiti, Ekiti State, Nigeria (we, us), concerning your access to and use of the <span class="text-primary">ækiti æmbassy</span> (<a href="https://aekiti.com" target="blank">https://aekiti.com</a>) website as well as any related applications (the Site).</p>
          ...
          <p>
            ...
            <ul>
              <li>Our Privacy Policy <a href="https://aekiti.com/privacy" target="blank">https://aekiti.com/privacy</a>, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.</li>
            </ul>
          </p>
        </div>
        ...
        <div>
          ...
          <p>3.1  You represent and warrant that: (a) all registration information you submit will be true, accurate, current, and complete and relate to you and not a third party; (b) you will maintain the accuracy of such information and promptly update such information as necessary; (c) you will keep your password confidential and will be responsible for all use of your password and account; (d) you have the legal capacity and you agree to comply with these Terms and Conditions; and (e) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Site. If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at <a href="mailto:contact@aekiti.com" target="_blank">contact@aekiti.com</a>.</p>
        ...
        <div>
          ...
          <p>4.7  If you wish to complain about User Content uploaded by other users please contact us at <a href="mailto:contact@aekiti.com" target="_blank">contact@aekiti.com</a>.</p>
        </div>
        ...
        <div>
          ...
          <p>10.1  These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at <a href="mailto:contact@aekiti.com" target="_blank">contact@aekiti.com</a>.</p>
        ...
        <div>
          ...
          <p>11.8  For entrepreneur only  - Please note that these Terms and Conditions, their subject matter and their formation, are governed by English law. You and we both agree that the courts of Nigeria will have exclusive jurisdiction. If you have any complaint or wish to raise a dispute under these Terms and Conditions or otherwise in relation to the Site please send a mail to <a href="mailto:contact@aekiti.com" target="_blank">contact@aekiti.com</a></p>
          ...
          <p>11.11  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at <a href="mailto:contact@aekiti.com" target="_blank">contact@aekiti.com</a> or by post to:</p>
          <p>ækiti æmbassy,<br>TechHub EKSU, Ekiti State University,<br>Ado-Ekiti, Ekiti State 360001,<br>Nigeria.</p>
        </div>
      </div>
    </div>
  </section>
