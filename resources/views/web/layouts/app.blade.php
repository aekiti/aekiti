...
<body class="x-hidden has-sticky-header">
          ...
          <div class="row">
            <div class="col-md-4 col-6">
              <div class="footer-widget">
                ...
                <ul class="list-unstyled">
                  <li>
                    <a href="https://aeternity.com/?utm_source=aekiti-aembassy" target="_blank" rel="follow">æternity</a>
                  </li>
                  <li>
                    <a href="https://forum.aeternity.com?u=aeternityekiti" target="_blank" rel="follow">forum</a>
                  </li>
                  <li>
                    <a href="https://aekiti.github.io/documentation-hub/site/" target="_blank" rel="follow">documentation hub</a>
                  </li>
                  <li>
                    <a href="https://devstudyjaem.aekiti.com" target="_blank" rel="follow">devstudyjæm</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-md-4 col-6">
              <div class="footer-widget">
                ...
                <ul class="list-unstyled">
                  <li>
                    <a href="https://youtube.com/channel/UCISZ6H0Zb-ndRLSgcR1sH_g" target="_blank" rel="follow"><i class="fab fa-youtube"></i> YouTube</a>
                  </li>
                  <li>
                    <a href="https://twitter.com/AeternityEkiti" target="_blank" rel="follow"><i class="fab fa-twitter"></i> Twitter</a>
                  </li>
                  <li>
                    <a href="https://telegram.me/aekiti" target="_blank" rel="follow"><i class="fab fa-telegram"></i> Telegram</a>
                  </li>
                  <li>
                    <a href="https://instagram.com/aekitiaembassy" target="_blank" rel="follow"><i class="fab fa-instagram"></i> Instagram</a>
                  </li>
                  <li>
                    <a href="https://facebook.com/aeternityekiti" target="_blank" rel="follow"><i class="fab fa-facebook"></i> Facebook</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-md-4">
              <div class="footer-widget">
                ...
                <ul class="list-unstyled">
                  <li>
                    <a href="https://github.com/aekiti/aekiti/issues/new?template=bug_report.md" target="_blank" rel="noreferrer">File a bug</a>
                  </li>
                  <li>
                    <a href="https://github.com/aekiti/aekiti/issues/new?template=feature_request.md" target="_blank" rel="noreferrer">Request new feature</a>
                  </li>
                  <li>
                    <a href="https://github.com/aekiti/aekiti" target="_blank" rel="noreferrer">View source</a>
                  </li>
                  <li class="d-sm-none">
                    <a href="javascript:;" onclick="share('{{ config('app.name') }}', '{{ config('app.url') }}', 'Looking for a place you can learn blockchain development for free? If yes, check out {{ config('app.nick') }} now')">Share <i class="fa fa-share-alt"></i></a> <div id="share-loader"><div class="spinner-grow"></div></div>
                  </li>
                  <li>
                    <div class="aekiti-superhero">Donate</div>
                  </li>
                </ul>
              </div>
            </div>
  ...
  <script type="text/javascript">
    superheroButton('.aekiti-superhero', { size: 'small', account: 'aeternityekiti.chain' });
  </script>
