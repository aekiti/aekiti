...
@push('css')
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/datatables.net-select-bs4/css/select.bootstrap4.min.css">
@endpush
...
@push('js')
    ...
    <script src="{{ asset('dashboard') }}/assets/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/datatables.net-buttons/js/buttons.flash.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/datatables.net-select/js/dataTables.select.min.js"></script>
@endpush
